...
*** Introduction and Overview
 Here's a good video overview of 4 major patterns of React components.
 #+BEGIN_EXPORT html
...
Dan Abramov strongly suggests separating Functional (Presentational) Components and Container components. [[https://medium.com/@dan_abramov/smart-and-dumb-components-7ca2f9a7c7d0][The Word of Dan]]
The distinction is usually drawn along the lines of [[https://medium.com/@yassimortensen/container-vs-presentational-components-in-react-8eea956e1cea][presentational components organizing the view]], while the container component may load / organize data. So if you use Functional Components like this, you're in good form!
...
*** TODO Get some Render Props from Powerplug
...
It's only 3kb minified! You may recognize a few of these Render Props as well
